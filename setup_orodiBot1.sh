...
# Prompt for BOT name
echo -e "\e[36mEnter a name for BOT (e.g., ordBot1):\e[0m"
read -r BOT_NAME
BOT_NAME=${BOT_NAME:-ordBot1}
...
echo -e "\e[33mCloning ordBot1 repository...\e[0m"
if ! git clone https://github.com/Paulorodi/ordBot1.git "$BOT_NAME"; then
